...
import DialogueComponent from "#srccomponents/DialogueComponent.tsx";
...
const Page = () => {
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
      ...
      <DialogueComponent open={AddModalShow} setIsOpen={setAddModalShow} content={<AddInstanceForm/>}/>
